...
È possibile effettuare path query, ovvero ottenere come output l'insieme di archi che legano due nodi del grafo.

Stardog garantisce la semantica transazionale supportando transazioni ACID\cite{stardog}.
